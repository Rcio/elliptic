  ...
  // test('p521');
    ...
    function test(opt) {
      opt.cases.forEach(function(c) {
        ...
        it(descr, function() {
          var sign = ecdsa.sign(parseHexString(c.message), opt.key);
    ...
    test({
      ...
      key: '26fbbb9bd4b3bc0605d040f2312edf50bef5b8c96d82c01214647d6ee81f1c',
      pub: {
        x: '2f85d7aa8fc95de6b43e29f47828c8c631e3a85161c740db90703c6292c021c6',
        y: '1d13048b338a15594b58104aad327752fee91dd6e3772f14d39b755c1ea1ed9d'
      },
      cases: [
        // {
        //   message: 'sample',
        ...
        // },
        {
          message: '7a7a73323233323234403136332e636f6d',
          hash: hash.sha256,
          r: 'c481f67e82ea4e6fa15638d50615c396d034b63e882a534a77b5291494903120',
          s: '2d93d74ba00929bf5041cb0c4bbd032656e76bfe92a91a43d96262b8119ab9a5'
        }
      ]
    });
